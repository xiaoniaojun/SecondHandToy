...
import cn.xiaoniaojun.secondhandtoy.databinding.FragmentOrderFormBinding;
import cn.xiaoniaojun.secondhandtoy.databinding.LayoutFormOrderStep1Binding;
import cn.xiaoniaojun.secondhandtoy.databinding.LayoutFormOrderStep2Binding;
import cn.xiaoniaojun.secondhandtoy.databinding.LayoutOrderConfirmationBinding;
...
public class OrderDialogFragment extends BottomSheetDialogFragment {
    ...
    public static OrderDialogFragment newInstance(ToysEntity product) {
    ...
    private ToysEntity getProduct() {
        return (ToysEntity) getArguments().getSerializable(ARG_PRODUCT);
    }

    private Drawable createProductImageDrawable(ToysEntity product) {
