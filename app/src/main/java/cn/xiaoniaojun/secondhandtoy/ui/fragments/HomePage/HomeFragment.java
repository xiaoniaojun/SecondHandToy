...
public class HomeFragment extends BaseMainFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        carouselView.config(4,500,5000);
        final String[] urls = new String[]{"https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1494700164024&di=074d34a5cabd25deced0063a84efb9fc&imgtype=0&src=http%3A%2F%2Fww1.sinaimg.cn%2Fmw600%2F005DHhhLjw9ejgs9ymlwgj30h20p1dkz.jpg",
        ...
        carouselView.post(new Runnable() {
            @Override
            public void run() {
                carouselView.setContentUrl(urls,mFragment);
            }
        });
