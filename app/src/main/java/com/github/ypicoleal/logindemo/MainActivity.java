...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tvLogin = (TextView) findViewById(R.id.login_tv);
    ...
    public void showSingUp(View view) {
        ...
        final int tv_target_color = Color.parseColor("#ccffffff");
        ...
        Animation a = new Animation() {
            ...
            protected void applyTransformation(float interpolatedTime, Transformation t) {
                ...
                animationSquare.getLayoutParams().width = (int) (square_target_width * interpolatedTime * 1.4);
        ...
        Animation a2 = new Animation() {
            @Override
            protected void applyTransformation(float interpolatedTime, Transformation t) {
                animationSquare.getLayoutParams().height = (int) (square_target_height * interpolatedTime * 1.4);
                animationSquare.requestLayout();
            }
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            ValueAnimator a5 = ValueAnimator.ofInt(Color.argb(255, 249, 164, 221),Color.argb(255, 19, 26, 86));
            a5.setEvaluator(new ArgbEvaluator());
            a5.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                @Override
                public void onAnimationUpdate(ValueAnimator animation) {
                    final int animatedValue = (int) animation.getAnimatedValue();
                    rootLayout.setBackgroundColor(animatedValue);
                    ((View) animationSquare.getParent()).setBackgroundColor(animatedValue);
                }
            });
            a5.setDuration(400);
            a5.start();
    ...
    public void showLogIn(View view) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            ValueAnimator a5 = ValueAnimator.ofInt(Color.argb(255, 19, 26, 86),Color.argb(255, 249, 164, 221));
            a5.setEvaluator(new ArgbEvaluator());
            a5.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                @Override
                public void onAnimationUpdate(ValueAnimator animation) {
    ...
    private void animateOnFocus(View v) {
        ...
        Animation a = new Animation() {
            ...
            protected void applyTransformation(float interpolatedTime, Transformation t) {
                ...
                int radius = first_target_radius + (int) (diff_radius * (1 - interpolatedTime));

                first_container.setRadius(radius);
                first_container.requestLayout();

                diff_radius = second_curr_radius - second_target_radius;
                radius = second_target_radius + (int) (diff_radius * (1 - interpolatedTime));
